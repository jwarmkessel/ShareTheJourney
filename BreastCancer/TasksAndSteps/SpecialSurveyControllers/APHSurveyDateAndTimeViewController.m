//
//  APHSurveyDateAndTimeViewController.m
//  Parkinson
//
...
#import "APHSurveyDateAndTimeViewController.h"

@interface APHSurveyDateAndTimeViewController  ( )
...
@property  (nonatomic, weak)  IBOutlet  UILabel       *selectTimeCaption;

@property  (nonatomic, weak)  IBOutlet  UIDatePicker  *dateSelector;

@end

@implementation APHSurveyDateAndTimeViewController
