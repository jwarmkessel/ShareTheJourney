...
- (RKSTTaskViewController *)consentViewController
{
    ...
    RKSTConsentDocument* consentVC = [[RKSTConsentDocument alloc] init];
    consentVC.title = @"Consent";
    consentVC.signaturePageTitle = @"Consent";
    consentVC.signaturePageContent = @"I agree  to participate in this research Study.";
    ...
    [consentVC addSignature:participantSig];
    ...
    consentVC.sections = [components copy];
    
    RKSTVisualConsentStep *step = [[RKSTVisualConsentStep alloc] initWithIdentifier:@"visual" document:consentVC];
    RKSTConsentReviewStep *reviewStep = [[RKSTConsentReviewStep alloc] initWithIdentifier:@"reviewStep" signature:participantSig inDocument:consentVC];
